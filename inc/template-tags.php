...
if ( ! function_exists( 'wpxpress_posted_by' ) ) :
	/**
...
if ( ! function_exists( 'wpxpress_entry_footer' ) ) :
	/**
	...
	function wpxpress_entry_footer() {
		...
		if ( 'post' === get_post_type() ) {
			...
			if ( $tags_list ) {
				...
				printf( '<span class="tags-links">' . esc_html__( 'Tagged %1$s', 'wpxpress' ) . '</span>', $tags_list ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
			}
		}
...
if ( ! function_exists( 'wpxpress_post_thumbnail' ) ) :
	 ...
	 */
	function wpxpress_post_thumbnail() {
